...
<tr>
    ...
    <td style="background-color:transparent; border-left: transparent; border-top: transparent; border-right: transparent; font-family:Arial, sans-serif;font-weight:bold; font-size:20px;" class="td" colspan="50" align="right"><b><h1>CHECKLIST DE<br>
    LOCAÇÃO</h1></b>
    </td>
    <td style="background-color:transparent; border-left: transparent; border-top: transparent; border-right: transparent; font-family:Arial, sans-serif;font-weight:bold; font-size:20px;" class="td" colspan="2" align="right">
    </td>
...
<tr style="height:16px;">
    ...
    <td colspan="20" align="left" background-color:"#cfcfcf" style="height:16px; border-style: hidden; border-left: thin solid; border-top: thin solid; border-right: thin solid; border-bottom: thin solid;">'. $empresa .'</td>
	
<td style="height:16px; border-style: hidden; border-left: thin solid; border-top: thin solid; border-right: thin solid; border-bottom: thin solid;background-color: #CCCCCC;" colspan="5" align=right><p><b>Vendedor:</b></p></td>
<td colspan="21" align="left" background-color:"#cfcfcf" style="height:16px; border-style: hidden; border-left: thin solid; border-top: thin solid; border-right: thin solid; border-bottom: thin solid;">Ricardo M. Huescar</p></td>
...
<td colspan="21" align="left" background-color:"#cfcfcf" style="border-style: hidden; border-left: thin solid; border-top: thin solid; border-right: thin solid; border-bottom: thin solid;">R$ 1.200,00(15dias)</p></td>
<td colspan="2"></td></tr>
...
<tr>
    ...
    <td style="border-style: none; border-top: thin solid;" colspan="15" align=center>Ricardo M. Uescar<br>Vendedor
    </td>
     <td colspan="2">
    </td>
    <td style="border-style: none; border-top: thin solid;" colspan="15" align=center>Rodrigo Martins Ferreira<br>Cliente
    </td>
    <td colspan="2">
    </td>
</tr> 
